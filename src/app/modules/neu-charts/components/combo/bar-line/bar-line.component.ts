...
import {
    Component, Input, ViewEncapsulation, Output, EventEmitter, ChangeDetectionStrategy,
    ViewChild, HostListener, OnInit, OnChanges, ContentChild, TemplateRef
} from '@angular/core';
import {
...
@Component({
    selector: 'neu-charts-combo-bar-line-raw',
    template: `
      <ngx-charts-chart
...
export class BarLineComponent extends BaseChartComponent {
    ...
    setColors(): void {
        ...
        this.customColors = this.scheme;
        this.colorSchemeLine = this.scheme;
        console.log(this.scheme, this.schemeType, domain, this.customColors, this.colorSchemeLine);
